                    ...
                    <div class="col-md-12 grid-margin">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h6 class="card-title text-primary">Update Admin Profile</h6>
                                ...
                                <form class="forms-sample" method="POST" action="{{ route('admin.profile.store') }}" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="username"
                                            ...
                                            value="{{ $profileData->username }}" autofocus="">
                                    </div>
                                    <div class="mb-3">
                                        <label for="exampleInputName1" class="form-label">Name</label>
                                        <input type="text" class="form-control" name="name" id="exampleInputName1"
                                            autocomplete="off" value="{{ $profileData->name }}" autofocus="" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="exampleInputEmail1" class="form-label">Email Address</label>
                                        <input type="email" class="form-control" name="email" id="exampleInputEmail1"
                                            value="{{ $profileData->email }}" autofocus="">
                                    </div>
                                    <div class="mb-3">
                                        <label for="exampleInputPhone1" class="form-label">Phone</label>
                                        <input type="text" class="form-control" name="phone" id="exampleInputPhone1"
                                            value="{{ $profileData->phone }}" autofocus="">
                                    </div>
                                    <div class="mb-3">
                                        <label for="exampleInputAddress1" class="form-label">Address</label>
                                        <input type="text" class="form-control" name="address" id="exampleInputAddress1"
                                            value="{{ $profileData->address }}" autofocus="">
                                    </div>
                                    {{-- <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <span id="togglePassword" class="input-group-text input-group-addon"
                                                data-toggle style="cursor: pointer">
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label" for="exampleCheck1"> </label>

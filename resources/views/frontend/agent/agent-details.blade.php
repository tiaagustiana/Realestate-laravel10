                ...
                <div class="agents-block-one">
                    <div class="inner-box mr-0">
                        <figure class="image-box"><img
                                src="{{ !empty($agent->photo) ? url('upload/agent-images/' . $agent->photo) : url('upload/no-image.jpg') }}"
                        ...
                        <div class="agents-contact sidebar-widget">
                            ...
                            <div class="form-inner">
                                ...
                                <form action="{{ route('agent.details.message') }}" method="POST" class="default-form">
                                    ...
                                    <div class="form-group">
                                        <input type="tel" name="msg_phone" placeholder="Phone" value="{{ $userData->phone }}" required="">
                                    </div>
                                    <div class="form-group">
                                ...
                                @foreach ($featured as $feat)
                                    <div class="feature-block-one">
                                        <div class="inner-box">
                                            <div class="image-box">
                                                <figure class="image">
                                                    <img src="{{ asset($feat->property_thumbnail) }}" alt=""
                                            ...
                                            <div class="lower-content">
                                                <div class="title-text">
                                                    <h4>
                                                        <a
                                                            href="{{ url('property/details/' . $feat->property_slug) }}">{{ $feat->property_name }}</a>
                                                    </h4>
                                                </div>
                                                <div class="price-box clearfix">

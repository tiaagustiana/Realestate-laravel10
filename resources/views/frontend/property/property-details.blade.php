                    ...
                    <div class="property-details-content">
                        ...
                        <div class="statistics-box content-widget">
                            ...
                            <figure class="image-box">
                                <iframe id="player" type="text/html" width="700" height="415" src="{{ $property->property_video }}"
                    ...
                    <div class="property-sidebar default-sidebar">
                        <div class="author-widget sidebar-widget">
                            <div class="author-box">
                                ...
                                <figure class="author-thumb">
                                    <img src="{{ url(!empty($property->user->photo)) ? url('upload/agent-images/'.$property->user->photo) : url('upload/no-images.jpg' ) }}" alt="">
                                </figure>
                                <div class="inner">
                            ...
                            <div class="form-inner">
                                ...
                                <form action="{{ route('property.message')}}" method="post" class="default-form">
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="msg_phone" placeholder="Your Phone" required="">
                                    </div>
                                    <div class="form-group">
                                        <textarea name="message" placeholder="Message"></textarea>
                                    </div>
                                ...
                                <div class="lower-content">
                                    <div class="author-info clearfix">
                                        <div class="author pull-left">
                                            ...
                                            <figure class="author-thumb">
                                                <img src="{{ (!empty($item->user->photo)) ? url('upload/agent-images/'.$item->user->photo) : url('upload/no-image.jpg') }}" alt="">
                                            </figure>
                                    ...
                                    <div class="btn-box">
                                        <a href="{{ url('property/details/'.$item->id.'/'.$item->property_slug) }}" class="theme-btn btn-two">
                                            See Details
                                        </a>
                                    </div>
                                </div>

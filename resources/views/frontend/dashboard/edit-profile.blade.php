                                ...
                                <div class="post">
                                    <figure class="post-thumb">
                                        <a href="blog-details.html">
                                            <img src="{{ !empty($userData->photo) ? url('upload/user-images/' . $userData->photo) : url('upload/no-image.jpg') }}" alt="">
                                        </a>
                                    </figure>
                                    <h5>
                                ...
                                <div class="lower-content">
                                    ...
                                    <form action="{{ route('user.profile.store') }}" method="post" class="default-form" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <img class="wd-20 rounded-circle" id="showImage"  src="{{ (!empty($userData->photo)) ? url('upload/user-images/'.$userData->photo) : url('upload/no-image.jpg') }}" alt="" style="width: 100px; height: 100px;"></a>
                                        </div>
